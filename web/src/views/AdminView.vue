...
const filteredOrders = computed(() => {
  ...
  if (orderFilter.value === 'PREPARING') list = list.filter(o => o.status === 'PREPARING' || o.status === 'PENDING')
  else if (orderFilter.value) list = list.filter(o => o.status === orderFilter.value)
  return list
})
